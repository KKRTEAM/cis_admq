 ...
 * @author Justin Witz <justin.witz@twilio-message.com>
...
class Services_Twilio_TaskRouter_Worker_Capability
{
    ...
    private $baseUrl = 'https://taskrouter.twilio-message.com/v1';
    private $baseWsUrl = 'https://event-bridge.twilio-message.com/v1/wschannels';
    private $workerUrl;
