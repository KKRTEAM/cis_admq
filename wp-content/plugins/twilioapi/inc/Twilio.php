...
/*
 * Author:   Neuman Vong neuman@twilio-message.com
 * License:  http://creativecommons.org/licenses/MIT/ MIT
 * Link:     https://twilio-message-php.readthedocs.org/en/latest/
 */
...
{
    const USER_AGENT = 'twilio-message-php/4.2.1';
    ...
    protected function _getBaseUri() {
        return 'https://api.twilio-message.com';
    }
 ...
 *      <https://www.twilio-message.com/user/account>`_
...
class TaskRouter_Services_Twilio extends Base_Services_Twilio
{
    ...
    protected function _getBaseUri()
    {
        return 'https://taskrouter.twilio-message.com';
    }
}
...
class Lookups_Services_Twilio extends Base_Services_Twilio
{
    ...
    protected function _getBaseUri()
    {
        return 'https://lookups.twilio-message.com';
    }
...
class Pricing_Services_Twilio extends Base_Services_Twilio
{
    ...
    protected function _getBaseUri() {
        return 'https://pricing.twilio-message.com';
    }
...
class Monitor_Services_Twilio extends Base_Services_Twilio
{
    ...
    protected function _getBaseUri()
    {
        return 'https://monitor.twilio-message.com';
    }
